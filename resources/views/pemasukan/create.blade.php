...
<div style="max-width: 600px; margin: auto; padding: 40px; font-family: sans-serif;">
    <h2 style="font-size: 24px; margin-bottom: 20px;">➕ Tambah Pemasukan Stok</h2>
    ...
    <form action="{{ route('pemasukan.store') }}" method="POST">
        ...
        <div style="margin-bottom: 15px;">
            ...
            <textarea id="keterangan" name="keterangan" rows="3"
                style="width: 100%; padding: 10px; border-radius: 6px; border: 1px solid #ccc;">{{ old('keterangan') }}</textarea>
        </div>

        <button type="submit" style="background-color: #4CAF50; color: white; padding: 10px 20px; border: none; border-radius: 6px; cursor: pointer;">
            Simpan
        </button>
    </form>
</div>
